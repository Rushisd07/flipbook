...
// import { useState, useEffect, useRef } from "react"
// import { Box, Button, Card, Typography, Chip, IconButton, AppBar, Toolbar, Dialog, Slide } from "@mui/material"
// import { ChevronLeft, ChevronRight, ZoomIn, ZoomOut, Refresh, Fullscreen, Close, Book } from "@mui/icons-material"
...
//   const nextPage = () => {
//     if (currentPage < data.pages.length - 2) {
//       setIsFlipping(true)
//       setTimeout(() => {
...
//     document.addEventListener("keydown", handleKeyPress)
//     return () => document.removeEventListener("keydown", handleKeyPress)
//   }, [currentPage, isFullscreen, onClose])
...
//                 transform: isFlipping ? "rotateY(-5deg)" : "none",
...
//                 <img
//                   src={data.pages[currentPage].imageData || "/placeholder.svg"}
...
//                 <img
//                   src={data.pages[currentPage + 1].imageData || "/placeholder.svg"}
...
//           <Box display="flex" alignItems="center" gap={2}>
//             <Typography variant="body2" color="text.secondary">
//               Page {currentPage + 1}-{Math.min(currentPage + 2, data.pages.length)} of {data.pages.length}
//             </Typography>

//             {/* Page thumbnails */}
//             <Box display="flex" gap={0.5} sx={{ maxWidth: 300, overflowX: "auto" }}>
//               {data.pages.map((page, index) => (
//                 <Box
//                   key={index}
//                   component="button"
//                   onClick={() => setCurrentPage(Math.floor(index / 2) * 2)}
//                   sx={{
//                     width: 32,
//                     height: 40,
//                     border: "1px solid",
//                     borderColor: index >= currentPage && index < currentPage + 2 ? "primary.main" : "grey.300",
//                     borderRadius: 1,
//                     overflow: "hidden",
//                     cursor: "pointer",
//                     flexShrink: 0,
...
//             endIcon={<ChevronRight />}
//             onClick={nextPage}
//             disabled={currentPage >= data.pages.length - 2 || isFlipping}
//           >
//             Next
//           </Button>
//         </Box>
...
//   if (isFullscreen) {
//     return (
//       <Dialog fullScreen open={isFullscreen} onClose={() => setIsFullscreen(false)} TransitionComponent={Transition}>
//         <ReaderContent />
//       </Dialog>
//     )
//   }
