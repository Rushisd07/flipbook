...
//   Paper,
// } from "@mui/material"
// import { Upload, InsertDriveFile, Download, Visibility, CloudUpload } from "@mui/icons-material"
...
//     <Box maxWidth="1200px" mx="auto">
//       {/* Upload Section */}
//       <Card sx={{ mb: 4, border: "2px dashed #ccc", "&:hover": { borderColor: "#1976d2" } }}>
//         <CardHeader>
...
//                   </Typography>
//                 </Box>
//                 <Chip label={`${pdfPages.length} pages`} color="primary" variant="outlined" />
//               </Box>
//             </Paper>
//           )}
...
//             <Card>
//               <CardHeader>
//                 <Typography variant="h5">Flipbook Preview</Typography>
//               </CardHeader>
//               <CardContent>
//                 <FlipbookPreview pages={pdfPages} />
//               </CardContent>
//             </Card>
//           </Grid>
...
//                   <Button variant="contained" size="large" startIcon={<Visibility />} onClick={openInViewer} fullWidth>
//                     Open in Viewer
//                   </Button>
//                   <Button variant="outlined" size="large" startIcon={<Download />} onClick={downloadFlipbook} fullWidth>
//                     Download Flipbook
//                   </Button>
//                 </CardContent>
//               </Card>
...
//                       <Typography fontWeight="medium">{pdfPages.length}</Typography>
//                     </Box>
//                     <Box display="flex" justifyContent="space-between">
//                       <Typography color="text.secondary">Format:</Typography>
//                       <Typography fontWeight="medium">PDF</Typography>
//                     </Box>
//                     <Box display="flex" justifyContent="space-between">
